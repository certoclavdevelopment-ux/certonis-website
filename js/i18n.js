...
(function () {
  ...
  var EN = {
    ...
    "hero.lead": "Certonis moves your company onto the world's largest open-source ERP. Process mapping, data analysis, configuration and migration are handled by AI — you get a fixed price, a clear schedule and a system that matches how you actually work and is open enough for AI to work inside it afterwards.",
    "hero.for": "For",
    ...
    "bc.eyebrow": "The new division of labour",
    "bc.title": "First the AI builds your ERP. Then it runs it.",
    "bc.lead": "That is the difference to every other ERP project: what you get at the end is not an empty system and a manual. The AI that built your processes stays inside them \u2014 and takes over the work your people type in by hand today.",
    "bc.p1t": "Build \u2014 4 to 20 weeks",
    "bc.p1d": "Claude Code maps your processes, migrates the legacy data and configures Odoo. The same work a consulting team schedules in quarters.",
    "bc.p2t": "Operation \u2014 from go-live, permanently",
    "bc.p2d": "The AI stays in the finished system and works inside it: creating, checking, posting, reporting. Your people only decide what is not clear-cut.",
    "bc.caption": "A Tuesday, six months after go-live",
    ...
    "bc.a2": "Handled by AI",
    "bc.l3": "A supplier invoice arrives by email. It is read, coded, checked against the delivery note, matched to the purchase order \u2014 and put in front of you for approval.",
    "bc.a3": "One click from you",
    ...
    "bc.a5": "Handled by AI",
    "bc.kicker": "This is what work looks like when the AI does not just write the system but stays inside it: nobody enters data any more, nobody hunts down documents. Your people decide the exceptions \u2014 and on a normal day that is a handful. The back office turns into a control room, staffed by the same people who used to fill in forms.",
    "bc.wink": "You still have to address the starship computer yourself, and it does not fetch the coffee either. Everything else is up for discussion.",
    ...
    "ct.phone": "Phone",
    "ct.hours": "Phone hours",
    "ct.hoursVal": "Mon–Thu 08:00–16:00 · Fri 08:00–13:00 (CET)",
