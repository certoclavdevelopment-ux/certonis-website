...
(function () {
  ...
  var EN = {
    ...
    "gw.eyebrow": "After go-live",
    "gw.title": "The real return starts afterwards.",
    "gw.lead": "Odoo is open source: a documented data model, a complete API, your data in your own database. That lets AI work inside the ERP rather than beside it \u2014 on real orders, real entries, real stock. In closed systems that is simply not provided for.",
    "gw.1t": "AI inside the system, not next to it",
    "gw.1d": "An assistant that knows your order book, drafts quotes, checks incoming invoices and writes reports \u2014 with access to the data already sitting in the ERP. No second tool, no export, no copy.",
    "gw.2t": "New automation in days",
    "gw.2d": "Whatever occurs to you two years from now is no longer a project but a matter of days. Because the interface is open, the data model documented, and nobody has to ask a vendor for permission first.",
    "gw.3t": "No vendor slowing you down",
    "gw.3d": "In closed systems every second AI idea dies at the interface, at the licence model or at the price per query. With open source the data is yours \u2014 and so is the decision about what happens to it.",
    "gw.kicker": "That is why the move pays off not once but again and again: you are not just switching software, you are laying the groundwork that lets your company use AI at all.",
